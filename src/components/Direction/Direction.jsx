...
const images = [
  ...
  },
  {
    ...
    buttons: [
      ...
      { title: <RightOutlined />, top: 50, left: 90, linkId: 4 },
      { title: <DownOutlined />, top: 90, left: 50, linkId: 2 },
    ],
    key: "ikki",
  },
  {
    ...
    src: img22,
    buttons: [
      { title: <LeftOutlined />, top: 50, left: 10, linkId: 5 },
      { title: <RightOutlined />, top: 50, left: 90, linkId: 5 },
      { title: <DownOutlined />, top: 90, left: 50, linkId: 3 },
    ],
    key: "tort",
  },
  {
    ...
    buttons: [
      ...
      { title: <RightOutlined />, top: 50, left: 90, linkId: 7 },
      { title: <DownOutlined />, top: 90, left: 50, linkId: 4 },
    ],
    key: "besh",
  },
  {
    id: 6,
    src: img4,
    buttons: [{ title: <LeftOutlined />, top: 50, left: 50, linkId: 5 }],
    key: "olti",
  },
  {
    id: 7,
    src: img5,
    buttons: [
      { title: <UpOutlined />, top: 50, left: 50, linkId: 8 },
      { title: <DownOutlined />, top: 90, left: 50, linkId: 5 },
    ],
    key: "yetti",
  },
  {
    ...
    src: img6,
    buttons: [
      { title: <LeftOutlined />, top: 50, left: 10, linkId: 9 },
      { title: <RightOutlined />, top: 50, left: 90, linkId: 10 },
      { title: <DownOutlined />, top: 90, left: 50, linkId: 7 },
    ],
    key: "sakkiz",
  },
  {
    id: 9,
    src: img7,
    buttons: [{ title: <DownOutlined />, top: 90, left: 50, linkId: 8 }],
    key: "sakkiz",
  },
  {
    id: 10,
